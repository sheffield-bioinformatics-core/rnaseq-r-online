...
The metadata columns can also be re-assigned. This useful in this case because we can see that `Status` is not stored as a factor, which could cause problems later on when we want to use `Status` in the differential expression.
